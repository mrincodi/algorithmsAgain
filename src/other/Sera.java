...
public class Sera {
	...
	public static void main ( String [] args ){
		...
		java.util.ArrayList <Integer> a = new java.util.ArrayList <Integer> (java.util.Arrays.asList(3,4,5));
		java.util.ArrayList <Integer> b = new java.util.ArrayList <Integer> (java.util.Arrays.asList(3,7,5));

		if ( a.equals(b)) System.out.println("Iguales");
	}
}
